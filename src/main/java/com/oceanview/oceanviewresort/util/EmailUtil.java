...
public class EmailUtil {
    ...
    public static void sendOtp(String toEmail, String otp) {
        ...
        String body = "<div style='font-family:Georgia,serif;max-width:520px;margin:0 auto;background:#f5efe6;padding:32px;border-radius:12px'>"
                +
                ...
                +
                "<div style='background:#1a3a4a;color:#c9a84c;font-size:36px;font-weight:700;letter-spacing:12px;text-align:center;padding:20px;border-radius:8px;margin-bottom:24px'>"
                + otp + "</div>" +
    ...
    public static void sendBookingConfirmation(String toEmail, String guestName,
        ...
        String body = "<div style='font-family:Georgia,serif;max-width:560px;margin:0 auto;background:#f5efe6;padding:32px;border-radius:12px'>"
                +
                "<div style='background:#1a3a4a;padding:24px 32px;border-radius:8px;text-align:center;margin-bottom:24px'>"
                +
                "<h1 style='font-family:Georgia,serif;color:#ffffff;font-weight:300;font-size:22px;margin:0'>Ocean View <span style='color:#c9a84c;font-style:italic'>Resort</span></h1>"
                ...
                +
                "<p style='color:#4a5a65;font-size:14px;margin-bottom:24px'>Dear " + guestName
    ...
    public static void sendBill(String toEmail, String guestName,
        ...
        String body = "<div style='font-family:Georgia,serif;max-width:560px;margin:0 auto;background:#f5efe6;padding:32px;border-radius:12px'>"
                ...
                "<p style='color:#4a5a65;font-size:14px;margin-bottom:16px'>Dear " + guestName
                + ", please find your invoice below.</p>" +
                ...
                +
                "<span style='color:#e2c47a;font-size:24px;font-family:Georgia,serif'>LKR "
                + String.format("%,.0f", total) + "</span></div>" +
    ...
    private static String row(String label, String value) {
        return "<tr style='border-bottom:1px solid #e8ddd0'>" +
                "<td style='padding:10px 12px;color:#7a8f9a;font-size:12px;text-transform:uppercase;letter-spacing:0.1em;width:40%'>"
                + label + "</td>" +
