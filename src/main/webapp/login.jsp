<%-- Document : Login (Login Page) Project : Ocean View Resort - Room Reservation System Author : Student --%>
    <%@page contentType="text/html" pageEncoding="UTF-8" %>
        <%@ page session="true" %>
            <% // If already logged in, redirect appropriately String role=(String) session.getAttribute("role"); if
                (role !=null) { if (role.equals("admin")) { response.sendRedirect(request.getContextPath()
                + "/admin.jsp" ); } else { response.sendRedirect(request.getContextPath() + "/guest-dashboard" ); }
                return; } %>
                <!DOCTYPE html>
                <html lang="en">
                ...
                <body>
                    ...
                    <div class="panel-left">
                        ...
                        <div class="brand">
                            <svg class="brand-icon" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M8 30 Q14 22 20 28 Q26 34 32 24 Q38 14 42 20" stroke="#c9a84c"
                                    stroke-width="1.5" fill="none" stroke-linecap="round" />
                                <path d="M6 35 Q14 27 22 33 Q30 39 40 28" stroke="rgba(201,168,76,0.4)" stroke-width="1"
                                    fill="none" stroke-linecap="round" />
                                <circle cx="24" cy="18" r="5" stroke="rgba(255,255,255,0.6)" stroke-width="1"
                                    fill="none" />
                        ...
                        <div class="hero-text">
                            ...
                            <p>Manage reservations, guest experiences, and hospitality operations — all from one elegant
                                system.</p>
                        ...
                        <svg class="wave-art" viewBox="0 0 800 200" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M0,80 C80,10 160,150 240,80 C320,10 400,150 480,80 C560,10 640,150 720,80 C780,20 800,60 800,80 L800,200 L0,200 Z"
                                fill="white" />
                        </svg>
                    </div>
                    ...
                    <div class="panel-right">
                        <div class="login-box">
                            ...
                            font-size:0.83rem; color:#2d7d5a; display:flex; align-items:center; gap:8px;">
                                    ...
                                    <% } %>
                                        ...
                                        <% String loginError=request.getParameter("error"); if
                                            ("true".equals(loginError)) { %>
                                            <div class="error-msg">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-wrap">
                                                            ...
                                                            <input type="email" id="email" name="email"
                                                                placeholder="you@oceanviewresort.lk" required
                                                                autocomplete="email">
                        ...
                        ">👁</span>
                                                ...
                                                <div style="margin-top:10px; text-align:center; font-size:0.82rem;">
                                                    <a href="${pageContext.request.contextPath}/index.jsp"
                                                        style="color: var(--ocean-mid); text-decoration:none;">
                                                        Back to Home
                                                    </a>
                                                </div>
